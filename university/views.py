...
def faculty_delete(request, pk):
    ...
    actions = request.session.get('actions', [])
    actions += [f"You delete faculty: {request.POST.get('name')}"]
    request.session['actions'] = actions
...
def kafedra_edit(request, pk):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You edit kafedra: {request.POST.get('name')}"]
        request.session['actions'] = actions
...
def kafedra_delete(request, pk):
    ...
    actions = request.session.get('actions', [])
    actions += [f"You delete kafedra: {request.POST.get('name')}"]
    request.session['actions'] = actions
...
def subject_delete(request,pk):
    ...
    actions = request.session.get('actions', [])
    actions += [f"You delete subject: {request.POST.get('name')}"]
    request.session['actions'] = actions
...
def teacher_delete(request,pk):
    ...
    actions = request.session.get('actions', [])
    actions += [f"You delete teacher: {request.POST.get('first_name')}"]
    request.session['actions'] = actions
...
def group_edit(request,pk):
    ...
    return render(request,'group/from.html',ctx)
...
def group_delete(request,pk):
    ...
    actions = request.session.get('actions', [])
    actions += [f"You delete group: {request.POST.get('name')}"]
    request.session['actions'] = actions
...
def student_delete(request,pk):
    ...
    actions = request.session.get('actions', [])
    actions += [f"You delete student: {request.POST.get('first_name')}"]
    request.session['actions'] = actions
